...
export default function SignUp() {
  ...
  const handleSignup = async () => {
    // Validation
    if (!name || !surname || !email || !password || !confirmPassword || !age || !country) {
      ...
      >
        ...
        >
          ...
          <TouchableOpacity
            ...
            disabled={loading}
          >
            <Text style={styles.submitButtonText}>{loading ? "Please wait..." : "Sign Up"}</Text>
...
const styles = StyleSheet.create({
  ...
  errorText: { color: "#FF4D4F", fontSize: 14, marginTop: 10, textAlign: "center" },
});